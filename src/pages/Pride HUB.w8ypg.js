...
// Landing Page Component (included here for self-containment)
const LandingPage = ({ onEnterApp }) => {
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center p-4 font-inter text-white text-center"
      style={{
        backgroundImage: 'url(https://i.imgur.com/8mwKV54.jpeg)',
...
// Main App component (now includes all data)
const App = () => {
  ...
  // State for the schedule/vendor search query
    ...
    },
    {
      ...
      event: (
        <>
          Parade Line Up ({' '}
          <a
            href="https://maps.google.com/?q=300 East Main Street, Batavia, NY"
            target="_blank"
  ...
  const vendorCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'CORE LEARNING CENTER', plainText: 'CORE LEARNING CENTER', link: 'https://www.instagram.com/corethelearningcenter' },
        { name: 'OAK ORCHARD COMMUNITY HEALTH CENTER', plainText: 'OAK ORCHARD COMMUNITY HEALTH CENTER', link: 'https://oakorchardhealth.org/' },
    ...
    },
    {
      ...
      items: [
        { name: 'Kolleen Zaffrann Crafts', plainText: 'Kolleen Zaffrann Crafts' },
        { name: 'CrafTerri Designs', plainText: 'CrafTerri Designs' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Cooling Station', plainText: 'Cooling Station' },
        { name: 'First Aid', plainText: 'First Aid' },
